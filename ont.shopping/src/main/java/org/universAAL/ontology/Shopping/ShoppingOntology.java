...
public final class ShoppingOntology extends org.universAAL.middleware.owl.Ontology {
    ...
    public static final String NAMESPACE = Resource.uAAL_NAMESPACE_PREFIX + "FoodManagement.owl#";
    ...
    public void create() {
		...
		oci.addRestriction(MergedRestriction.getAllValuesRestrictionWithCardinality(
				FoodItem.PROP_QUANTITY, TypeMapper.getDatatypeURI(Integer.class), 1, 1));
				//.addRestriction(new BoundedValueRestriction(FoodItem.PROP_QUANTITY, new Integer(0), true, new Integer(100), true)));
		...
		oci.addRestriction(MergedRestriction.getAllValuesRestrictionWithCardinality(
				Refrigerator.PROP_DEVICE_STATUS, TypeMapper.getDatatypeURI(Integer.class), 1, 1));
				//.addRestriction( new BoundedValueRestriction(Refrigerator.PROP_DEVICE_STATUS,new Integer(0), true, new Integer(100), true)));
		oci.addRestriction(MergedRestriction.getAllValuesRestrictionWithCardinality(
		...
		oci.addRestriction(MergedRestriction.getAllValuesRestrictionWithCardinality(
				ShoppingList.PROP_HAS_FOODITEMS, FoodItem.MY_URI, 1, -1));
		...
		oci.addRestriction(MergedRestriction.getAllValuesRestriction(
				FoodManagement.PROP_SHOPPINGLIST_CONTROLS, ShoppingList.MY_URI));
