...
The ZWaveDataPublisher is the service that publishes the information. In order to use the service you need: 
...
You'll be able to use the power consumption reading of the ZWaveDataPublisher right away. 
...
Now you can use the ZWaveDataPublisher in  it's full power. 


The ZwavwDataConsumer is an example of Context Bus Subscriber that consumes information of the three types, so you can see how the Publisher works. 