...
public class DispenserDisplayInstructionsDialogProvider extends ServiceCallee {

  private static final String NAMESPACE = "http://ontologies.universAAL.com/Medication.owl#";
  private static final String MY_URI = NAMESPACE + "DispenserDisplayInstructionsDialogService";
  ...
  public DispenserDisplayInstructionsDialogProvider(ModuleContext context, ServiceProfile[] realizedServices) {
    super(context, realizedServices);
    this.ctxt = context;
  }

  public DispenserDisplayInstructionsDialogProvider(ModuleContext context) {
  ...
  private static ServiceProfile[] getProfiles() {
    ServiceProfile initDP = InitialServiceDialog
        .createInitialDialogProfile(
            ...
            "Medication Manager : Dispenser display instructions Dialog",
            START_UI);
