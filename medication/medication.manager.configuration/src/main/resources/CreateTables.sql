...
CREATE TABLE MEDICATION_MANAGER.DISPENSER (
  ...
  DUE_INTAKE_ALERT        BOOLEAN NOT NULL,
  MISSED_INTAKE_ALERT     BOOLEAN NOT NULL,
  SUCCESSFUL_INTAKE_ALERT BOOLEAN NOT NULL,
  UPSIDE_DOWN_ALERT       BOOLEAN NOT NULL,
...
CREATE TABLE MEDICATION_MANAGER.TREATMENT (
  ...
  SHORTAGE_ALERT          BOOLEAN NOT NULL,
