...
public final class Activator implements BundleActivator {
  ...
  public static void validateParameter(int parameter, String parameterName) {
    ...
    if (parameter <= 0) {
      throw new MedicationManagerEventIssuerException("The parameter : " +
  ...
  public static void validateParameter(Object parameter, String parameterName) {
    ...
    if (parameter == null) {
      throw new MedicationManagerEventIssuerException("The parameter : " + parameterName + " cannot be null");
    }
