...
import org.universAAL.AALapplication.medication_manager.servlet.ui.acquire.medicine.impl.servlets.forms.DisplaySuccessfulMessageScriptForm;
 ...
 */
public final class DisplaySuccessfulPageWriterServlet extends BaseHtmlWriterServlet {

  private final Object lock = new Object();

  public DisplaySuccessfulPageWriterServlet(SessionTracking sessionTracking) {
    super(Util.SUCCESS_FILE_NAME, sessionTracking);
  }
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
    ...
    synchronized (lock) {
      try {
        ...
        if (message == null) {
          throw new MedicationManagerAcquireMedicineException("Missing successful message");
        }
  ...
  private void handleResponse(HttpServletResponse resp, String message) throws IOException {
    try {
      ScriptForm scriptForm = new DisplaySuccessfulMessageScriptForm(message);
