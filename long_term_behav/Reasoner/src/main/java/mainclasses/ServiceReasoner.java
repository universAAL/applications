...
public class ServiceReasoner extends Service {
	...
	static {
		...
		// My URI its called
		// "http://ontology.tsbtecnologias.es/Reasoner.owl#ReasonerService
		...
		PROPERTY_CONTROLS = Device.uAAL_DEVICE_NAMESPACE + "controls_reasoner";

		// I register the service ontology
		register(ServiceReasoner.class);
	...
	public static Restriction getClassRestrictionsOnProperty(String propURI) {
		...
		return ServiceReasoner.getClassRestrictionsOnProperty(propURI);
	}
	...
	public ServiceReasoner(String uri) {
		super(uri);
	}
