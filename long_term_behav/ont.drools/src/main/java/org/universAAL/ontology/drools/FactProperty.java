...
public class FactProperty extends ManagedIndividual {
  ...
  static {
	...
	MY_URI = FactProperty.MY_NAMESPACE + "FactProperty";
	// Now declare the URIs of the properties. They must start with lower
	// case.
	PROP_KEY = FactProperty.MY_NAMESPACE + "hasFactKeyProperty";
	PROP_VALUE = FactProperty.MY_NAMESPACE + "hasFactValueProperty";
