...
public class Rule extends ManagedIndividual {
  ...
  static {
	...
	MY_URI = Rule.MY_NAMESPACE + "Rule";
	// Now declare the URIs of the properties. They must start with lower
	// case.
	PROP_ID = Rule.MY_NAMESPACE + "hasRuleID";
	PROP_BODY = Rule.MY_NAMESPACE + "hasRuleBODY";
  ...
  public static String getRDFSLabel() {
	return "Rule ontology properties ID and Body'";
  }
  ...
  public String getBODY() {
	return (String) props.get(PROP_BODY);
  }

  public void setBODY(String str) {
	props.put(PROP_BODY, str);
  }
