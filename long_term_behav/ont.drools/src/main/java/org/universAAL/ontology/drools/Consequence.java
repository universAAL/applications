...
public class Consequence extends ManagedIndividual {
  ...
  public static final String PROP_ConsequenceProperty;
  ...
  static {
	...
	MY_URI = Consequence.MY_NAMESPACE + "Consequence";
	// Now declare the URIs of the properties. They must start with lower
	// case.
	PROP_ID = Consequence.MY_NAMESPACE + "hasConsequenceID";
	
	PROP_ConsequenceProperty = ConsequenceProperty.MY_NAMESPACE + "hasConsequenceProperty";
	// This line registers the ontology concept in the platform
	register(Consequence.class);
  }
  ...
  public static Restriction getClassRestrictionsOnProperty(String propURI) {
	...
	if (PROP_ConsequenceProperty.equals(propURI))
	    // This restriction means that in this property there can be none,
	    // one or many Sensor concepts
	    return Restriction.getAllValuesRestriction(propURI, ConsequenceProperty.MY_URI);
  ...
  public static String[] getStandardPropertyURIs() {
	...
	toReturn[i++] = PROP_ID;
	toReturn[i] = PROP_ConsequenceProperty;
  ...
  public ConsequenceProperty[] getConsequenceProperty() {
		Object propList = props.get(PROP_ConsequenceProperty);
  ...
  public void setConsequenceProperty(ConsequenceProperty[] consequenceProperty) {
	List propList = new ArrayList(consequenceProperty.length);
	for (int i = 0; i < consequenceProperty.length; i++) {
	    propList.add(consequenceProperty[i]);
	}
	props.put(PROP_ConsequenceProperty, consequenceProperty);
  }
