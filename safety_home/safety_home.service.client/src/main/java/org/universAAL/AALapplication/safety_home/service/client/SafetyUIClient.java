...
public class SafetyUIClient extends javax.swing.JPanel {
	...
	private MyJPanel createPanel(final Device device) {
		...
		ImageIcon unlockButtonIcon = new ImageIcon((java.net.URL)SafetyUIClient.class.getResource("/images/unlock.png"));
		...
		ImageIcon lockButtonIcon = new ImageIcon((java.net.URL)SafetyUIClient.class.getResource("/images/lock.png"));
