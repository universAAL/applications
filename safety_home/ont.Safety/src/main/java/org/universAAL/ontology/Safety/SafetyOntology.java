...
public final class SafetyOntology extends Ontology {
	...
	oci.addRestriction(MergedRestriction
		...
		.addRestriction(
			MergedRestriction.getAllValuesRestriction(
				Door.PROP_DEVICE_STATUS, new IntRestriction(
					new Integer(0), true, new Integer(100),
					true))));
	oci.addRestriction(MergedRestriction
	...
	oci.addRestriction(MergedRestriction
		.getAllValuesRestrictionWithCardinality(
			HumiditySensor.PROP_DEVICE_STATUS,
			TypeMapper.getDatatypeURI(Integer.class), 1, 1)
		.addRestriction(
			MergedRestriction.getAllValuesRestriction(
				Door.PROP_DEVICE_STATUS, new IntRestriction(
	...
	oci.addRestriction(MergedRestriction
		.getAllValuesRestrictionWithCardinality(
			LightSensor.PROP_DEVICE_STATUS,
			TypeMapper.getDatatypeURI(Integer.class), 1, 1)
		.addRestriction(
			MergedRestriction.getAllValuesRestriction(
				LightSensor.PROP_DEVICE_STATUS,
	...
	oci.addRestriction(MergedRestriction
		.getAllValuesRestrictionWithCardinality(
			MotionSensor.PROP_DEVICE_STATUS,
			TypeMapper.getDatatypeURI(Integer.class), 1, 1)
		.addRestriction(
			MergedRestriction.getAllValuesRestriction(
				MotionSensor.PROP_DEVICE_STATUS,
				new IntRestriction(0, true, 100, true))));
	oci.addRestriction(MergedRestriction
		.getAllValuesRestrictionWithCardinality(
	...
	oci.addRestriction(MergedRestriction
		.getAllValuesRestrictionWithCardinality(
			SmokeSensor.PROP_DEVICE_STATUS,
			TypeMapper.getDatatypeURI(Integer.class), 1, 1)
		.addRestriction(
			MergedRestriction.getAllValuesRestriction(
				SmokeSensor.PROP_DEVICE_STATUS,
	...
	oci.addRestriction(MergedRestriction
		.getAllValuesRestrictionWithCardinality(
			TemperatureSensor.PROP_DEVICE_STATUS,
			TypeMapper.getDatatypeURI(Integer.class), 1, 1)
		.addRestriction(
			MergedRestriction.getAllValuesRestriction(
				TemperatureSensor.PROP_DEVICE_STATUS,
	...
	oci.addRestriction(MergedRestriction
		.getAllValuesRestrictionWithCardinality(
			Window.PROP_DEVICE_STATUS,
			TypeMapper.getDatatypeURI(Integer.class), 1, 1)
		.addRestriction(
			MergedRestriction.getAllValuesRestriction(
				Window.PROP_DEVICE_STATUS, new IntRestriction(
					new Integer(0), true, new Integer(100),
					true))));
	oci.addRestriction(MergedRestriction
		.getAllValuesRestrictionWithCardinality(
