...
public class LightSensor extends Device {
	...
	public static Restriction getClassRestrictionsOnProperty(String propURI) {
		...
		if (PROP_SENSOR_STATUS.equals(propURI))
			return OrderingRestriction.newOrderingRestriction(new Integer(1000),
				    new Integer(0), true, true, Restriction
					    .getAllValuesRestrictionWithCardinality(propURI,
						    TypeMapper.getDatatypeURI(Integer.class),
						    1, 1));
	...
	public static String[] getStandardPropertyURIs() {
		...
		return new String[] {PROP_DEVICE_LOCATION, PROP_DEVICE_STATUS, PROP_SENSOR_STATUS};
	}
	
	public static String getRDFSComment() {
		return "A light sensor";
	}
