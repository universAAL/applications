...
public class LightSensor extends Device {
	...
	public static final String PROP_SENSOR_STATUS = SafetyOntology.NAMESPACE + "homeLight";
	...
	public static String[] getStandardPropertyURIs() {
		...
		return new String[] {PROP_PHYSICAL_LOCATION, PROP_DEVICE_STATUS, PROP_SENSOR_STATUS};
	}
/*	
