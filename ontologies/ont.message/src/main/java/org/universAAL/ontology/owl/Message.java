...
public class Message extends ManagedIndividual {
    public static final String MY_URI = MessageOntology.NAMESPACE + "Message";
    ...
    public static final String PROP_CONTENT = MessageOntology.NAMESPACE
	    + "content";
    public static final String PROP_READ = MessageOntology.NAMESPACE + "read";
	...
	return true && props.containsKey(PROP_SENDER)
