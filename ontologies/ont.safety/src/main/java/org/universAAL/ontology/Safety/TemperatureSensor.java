...
public class TemperatureSensor extends Device {
    ...
    public static final String PROP_DEVICE_STATUS = SafetyOntology.NAMESPACE
	    + "deviceStatus";
    public static final String PROP_TEMPERATURE = SafetyOntology.NAMESPACE
	    + "homeTemperature";
    ...
    /*
     * public static String getRDFSComment() { return "A temperature sensor"; }
     * 
     * public static String getRDFSLabel() { return "Temperature"; }
     */
