...
public class MotionSensor extends Device {
    ...
    public static final String PROP_DEVICE_STATUS = SafetyOntology.NAMESPACE
	    + "deviceStatus";
    public static final String PROP_MOTION = SafetyOntology.NAMESPACE
	    + "homeMotion";
    ...
    /*
     * public static String getRDFSComment() { return "A motion sensor"; }
     * 
     * public static String getRDFSLabel() { return "Motion"; }
     */
