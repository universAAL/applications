...
public class MeasureUnit extends ManagedIndividual {
    ...
    public static final MeasureUnit MILLIGRAMS = new MeasureUnit(
	    VALUE_MILLIGRAMS, 0);
    public static final MeasureUnit GRAMS = new MeasureUnit(VALUE_GRAMS, 1);
    public static final MeasureUnit KILOGRAMS = new MeasureUnit(
	    VALUE_KILOGRAMS, 2);
    public static final MeasureUnit MILLILITERS = new MeasureUnit(
	    VALUE_MILLILITERS, 3);
    ...
    public static final MeasureUnit TABLESPOONS = new MeasureUnit(
	    VALUE_TABLESPOONS, 6);
    public static final MeasureUnit TEASPOONS = new MeasureUnit(
	    VALUE_TEASPOONS, 7);
    public static final MeasureUnit UNITS = new MeasureUnit(VALUE_UNITS, 8);
    public static final MeasureUnit HANDFULLS = new MeasureUnit(
	    VALUE_HANDFULLS, 9);
	...
	return new ManagedIndividual[] { MILLIGRAMS, GRAMS, KILOGRAMS, LITERS,
		MILLILITERS, LITERS, CUPS, TABLESPOONS, TEASPOONS, UNITS,
		HANDFULLS };
    }
