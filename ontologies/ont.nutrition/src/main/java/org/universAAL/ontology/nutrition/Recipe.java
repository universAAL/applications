...
public class Recipe extends ManagedIndividual {
    ...
    // properties
    public static final String PROP_ID = NutritionOntology.NAMESPACE + "id"; // integer
    public static final String PROP_NAME = NutritionOntology.NAMESPACE + "name"; // String
	 ...
	 * PROP_PHYSICAL_LOCATION // PROP_SOURCE_LOCATION .equals(propURI)) ?
	...
	this.props.put(PROP_DISH_CATEGORY, DishCategory
		.getDishCategoriesByOrder(value));
    }
