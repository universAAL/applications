...
public class DishCategory extends ManagedIndividual {
    ...
    public static final DishCategory DESSERT = new DishCategory(VALUE_DESSERT,
	    0);
    public static final DishCategory DRINK = new DishCategory(VALUE_DRINK, 1);
    public static final DishCategory FIRST_COURSE = new DishCategory(
	    VALUE_FIRST_COURSE, 2);
    public static final DishCategory MAIN_COURSE = new DishCategory(
	    VALUE_MAIN_COURSE, 3);
    public static final DishCategory SIDE_DISH = new DishCategory(
	    VALUE_SIDE_DISH, 4);
    public static final DishCategory STARTER = new DishCategory(VALUE_STARTER,
	    5);
    public static final DishCategory BREAKFAST = new DishCategory(
	    VALUE_BREAKFAST, 6);
