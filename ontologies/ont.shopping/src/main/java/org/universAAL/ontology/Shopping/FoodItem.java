...
public class FoodItem extends ManagedIndividual {
	...
	PROP_INSERTION_DATE = ShoppingOntology.NAMESPACE
		+ "foodItemInsertionDate";
	PROP_EXPIRATION_DATE = ShoppingOntology.NAMESPACE
    ...
    public FoodItem(String uri, int code, String name, String size,
	    String company) {
	super(uri);
	if (name == null)
	    throw new IllegalArgumentException();
    ...
    public FoodItem(String uri, String name, Double quantity, String size,
	    String company, int code) {
	super(uri);
	if (name == null)
	    throw new IllegalArgumentException();
    ...
    public FoodItem(String uri, String name, Double quantity, String size,
	    String company, int code, String tagID) {
	super(uri);
	if (name == null)
	    throw new IllegalArgumentException();
    ...
    public FoodItem(String uri, String name, Double quantity, String size,
	    String company, String tagID, String insDate, String expDate) {
	super(uri);
	if (name == null)
	    throw new IllegalArgumentException();
    ...
    public FoodItem(String uri, String name, Double quantity, String size,
	    String company, int code, String tagID, String insDate,
	    String expDate) {
	super(uri);
	if (name == null)
	    throw new IllegalArgumentException();
