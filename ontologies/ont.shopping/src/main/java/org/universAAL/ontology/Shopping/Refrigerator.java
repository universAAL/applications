...
public class Refrigerator extends Device {
    public static final String MY_URI = ShoppingOntology.NAMESPACE
	    + "Refrigerator";
    public static final String PROP_TEMPERATURE = ShoppingOntology.NAMESPACE
	    + "temperature";
    // public static final String PROP_PHYSICAL_LOCATION =
    // PROP_PHYSICAL_LOCATION;
    public static final String PROP_DEVICE_STATUS = ShoppingOntology.NAMESPACE
	    + "deviceStatus";
    public static final String PROP_HAS_FOODITEMS = ShoppingOntology.NAMESPACE
	    + "FoodItems";
	...
	return new String[] { PROP_TEMPERATURE, PROP_PHYSICAL_LOCATION,
		PROP_DEVICE_STATUS, PROP_HAS_FOODITEMS };
    }

    /*
     * public static String getRDFSComment() { return
     * "The class of all Refrigerators"; }
     * 
     * public static String getRDFSLabel() { return "Refrigerator"; }
     */
