...
public class EnergyMeasurement extends ManagedIndividual {
    ...
    public static final String MY_URI = ReadEnergyOntology.NAMESPACE
	    + "EnergyReaderMeassurement";
    public static final String PROP_HAS_VALUE = ReadEnergyOntology.NAMESPACE
	    + "hasValue";
    public static final String PROP_HAS_UNIT = ReadEnergyOntology.NAMESPACE
	    + "hasUnit";
