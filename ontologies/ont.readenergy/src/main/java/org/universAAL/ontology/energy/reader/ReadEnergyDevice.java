...
public class ReadEnergyDevice extends ManagedIndividual {
    ...
    public static final String MY_URI = ReadEnergyOntology.NAMESPACE
	    + "EnergyReaderDevice";
    public static final String PROP_HAS_TYPE = ReadEnergyOntology.NAMESPACE
	    + "hasType";
    public static final String PROP_HAS_NAME = ReadEnergyOntology.NAMESPACE
	    + "hasName";
    public static final String PROP_HAS_PLACE = ReadEnergyOntology.NAMESPACE
	    + "hasPlace";
