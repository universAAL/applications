 ...
 * Service Callee del ServicioSMS. Clase que contiene el m�todo llamado cuando se invoca un servicio desde el bus 
 * de servicio
 * 
 * @author mllorente
...
public class SMSCallee extends ServiceCallee {
    ...
    // Metodos
    /** Obligatorio de implementar. Sin inter�s (de momento) */
    ...
    /**
     * Este m�todo manda un SMS al n�mero especificado (necesita recibir el
