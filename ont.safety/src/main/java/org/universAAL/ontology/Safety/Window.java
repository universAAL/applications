 ...
 * @author dimokas
 * 
 *         Window sensor Ontology
 */
public class Window extends Device {
    public static final String MY_URI = SafetyOntology.NAMESPACE + "Window";
    ...
    /*
     * public static String getRDFSComment() { return "A window"; }
     * 
     * public static String getRDFSLabel() { return "Window"; }
     */
