...
public class SmokeSensor extends Device {
    ...
    public static final String PROP_DEVICE_STATUS = SafetyOntology.NAMESPACE
	    + "deviceStatus";
    public static final String PROP_SMOKE = SafetyOntology.NAMESPACE
	    + "homeSmoke";
    ...
    /*
     * public static String getRDFSComment() { return "A smoke sensor"; }
     * 
     * public static String getRDFSLabel() { return "Smoke"; }
     */
