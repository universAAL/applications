...
public class HumiditySensor extends Device {
	...
	public static final String PROP_HUMIDITY = SafetyOntology.NAMESPACE + "homeHumidity";
	...
	public static String[] getStandardPropertyURIs() {
		return new String[] {PROP_PHYSICAL_LOCATION, PROP_DEVICE_STATUS, PROP_HUMIDITY};
	}
/*	
