...
public class ProvidedLightingService extends Lighting {
    ...
    static final String SERVICE_SET_BRIGHTNESS = LIGHTING_SERVER_NAMESPACE
			+ "setBrightness";
    static final String INPUT_LAMP_BRIGHTNESS = LIGHTING_SERVER_NAMESPACE
			+ "lampBrightness";
	...
	ProvidedLightingService setBrightness = new ProvidedLightingService(
			SERVICE_SET_BRIGHTNESS);

			setBrightness.addFilteringInput(INPUT_LAMP_URI, LightSource.MY_URI, 1, 1, ppControls);

			setBrightness.addInputWithChangeEffect(INPUT_LAMP_BRIGHTNESS,TypeMapper.getDatatypeURI(Integer.class), 1, 1, ppBrightness);

			profiles[4] = setBrightness.myProfile;
