...
class FoodManagementClient extends ContextSubscriber {
	...
	private static ServiceRequest addShoppingListRequest(String shoppingURI, String shoppingListName, String shoppingListDate, String[] shoppingItems) {
		...
		addShoppingList.addValueFilter(new String[] { FoodManagement.PROP_CONTROLS }, new org.universAAL.ontology.Shopping.ShoppingList(shoppingURI));
		addShoppingList.addAddEffect(new String[] { FoodManagement.PROP_CONTROLS,org.universAAL.ontology.Shopping.ShoppingList.PROP_NAME }, shoppingListName);
		addShoppingList.addAddEffect(new String[] { FoodManagement.PROP_CONTROLS,org.universAAL.ontology.Shopping.ShoppingList.PROP_DATE }, shoppingListDate);
		addShoppingList.addAddEffect(new String[] { FoodManagement.PROP_CONTROLS,org.universAAL.ontology.Shopping.ShoppingList.PROP_HAS_FOODITEMS }, al);
	...
	private static ServiceRequest removeShoppingListRequest(String shoppingURI, String shoppingListName, int shoppingListID) {
		...
		removeShoppingList.getRequestedService().addInstanceLevelRestriction(r1, new String[] { FoodManagement.PROP_CONTROLS,org.universAAL.ontology.Shopping.ShoppingList.PROP_NAME });
		removeShoppingList.addRemoveEffect(new String[] { FoodManagement.PROP_CONTROLS,org.universAAL.ontology.Shopping.ShoppingList.PROP_NAME });
	...
	private static ServiceRequest removeFoodItemRequest(String deviceURI, String name) {
		...
		removeFoodItem.getRequestedService().addInstanceLevelRestriction(r1, new String[] { FoodManagement.PROP_CONTROLS,org.universAAL.ontology.Shopping.FoodItem.PROP_NAME });
		removeFoodItem.addValueFilter(new String[] { FoodManagement.PROP_CONTROLS }, new Refrigerator(deviceURI));
		removeFoodItem.addRemoveEffect(new String[] { FoodManagement.PROP_CONTROLS, FoodItem.PROP_NAME });
	...
	private static ServiceRequest getShoppingListItemsRequest(String URI, String shoppingListName) {
		...
		getShoppingListItems.addValueFilter(new String[] { FoodManagement.PROP_CONTROLS,org.universAAL.ontology.Shopping.ShoppingList.PROP_NAME }, shoppingListName);
	...
	private static ServiceRequest getShoppingItemsRequest() {
		...
		getShoppingItems.addRequiredOutput(OUTPUT_SHOPPING_ITEMS, new String[] {FoodManagement.PROP_CONTROLS,FoodItem.PROP_NAME });
	...
	private static ServiceRequest getShoppingListsRequest() {
		...
		getShoppingLists.addRequiredOutput(OUTPUT_SHOPPING_LISTS, new String[] {FoodManagement.PROP_CONTROLS,ShoppingList.PROP_NAME });
