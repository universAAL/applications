...
*/		
	...
	private Form submitButtons(Form f){
		...
		//new Submit(f.getSubmits(), new Label("Edit Shopping List", ((java.net.URL)UIProvider.class.getResource("/images/icons_shLstEdit_small.png")).toString()), SUBMISSION_EDIT);
