...
public class ProvidedFoodManagementService extends FoodManagement {
	...
	// All the static Strings are used to uniquely identify special functions and objects
	...
	String[] ppFridgeControls = new String[] {FoodManagement.PROP_FRIDGE_CONTROLS};
	String[] ppShoppingListControls = new String[] {FoodManagement.PROP_SHOPPINGLIST_CONTROLS};
	String[] ppStatus = new String[] {FoodManagement.PROP_FRIDGE_CONTROLS, Refrigerator.PROP_DEVICE_STATUS};
	String[] ppTemperature = new String[] {FoodManagement.PROP_FRIDGE_CONTROLS, Refrigerator.PROP_TEMPERATURE};
	String[] ppFoodItem = new String[] {FoodManagement.PROP_FRIDGE_CONTROLS, Refrigerator.PROP_HAS_FOODITEMS};

	addRestriction((MergedRestriction) FoodManagement
		.getClassRestrictionsOnProperty(FoodManagement.MY_URI,FoodManagement.PROP_FRIDGE_CONTROLS).copy(),  ppFridgeControls,serverFoodManagementRestrictions);
	...
	addRestriction(MergedRestriction.getAllValuesRestrictionWithCardinality(Refrigerator.PROP_TEMPERATURE,
		...
		getControlledDevices.addOutput(OUTPUT_CONTROLLED_DEVICES, Refrigerator.MY_URI, 0, 0,  ppFridgeControls);
		...
		getDeviceInfo.addFilteringInput(INPUT_DEVICE_URI, Refrigerator.MY_URI, 1, 1,  ppFridgeControls);
		getDeviceInfo.addOutput(OUTPUT_DEVICE_STATUS, TypeMapper.getDatatypeURI(Integer.class), 1, 1,ppStatus);
		getDeviceInfo.addOutput(OUTPUT_DEVICE_LOCATION,	Location.MY_URI, 1, 1, new String[] {FoodManagement.PROP_FRIDGE_CONTROLS, PhysicalThing.PROP_PHYSICAL_LOCATION});
		...
		turnOff.addFilteringInput(INPUT_DEVICE_URI, Refrigerator.MY_URI, 1, 1, ppFridgeControls);
		...
		turnOn.addFilteringInput(INPUT_DEVICE_URI, Refrigerator.MY_URI, 1, 1, ppFridgeControls);
		...
		changeTemperature.addFilteringInput(INPUT_DEVICE_URI, Refrigerator.MY_URI, 1, 1, ppFridgeControls);
		...
		addFoodItem.addFilteringInput(INPUT_DEVICE_URI, Refrigerator.MY_URI, 1, 1, ppFridgeControls);
		...
		removeFoodItem.addFilteringInput(INPUT_DEVICE_URI, Refrigerator.MY_URI, 1, 1, ppFridgeControls);
		removeFoodItem.addInputWithRemoveEffect(INPUT_FOODITEM_URI, TypeMapper
				.getDatatypeURI(String.class), 1, 1, new String[] {	FoodManagement.PROP_FRIDGE_CONTROLS,Refrigerator.PROP_HAS_FOODITEMS,FoodItem.PROP_NAME });
		...
		getFoodItems.addFilteringInput(INPUT_DEVICE_URI, Refrigerator.MY_URI, 1, 1, ppFridgeControls);
		...
		addShoppingList.addFilteringInput(INPUT_SHOPPINGLIST_URI, ShoppingList.MY_URI, 1, 1, ppShoppingListControls);
		addShoppingList.addInputWithAddEffect(INPUT_SHOPPINGNAME_URI, TypeMapper
				.getDatatypeURI(String.class), 1, 1, new String[] {
				FoodManagement.PROP_SHOPPINGLIST_CONTROLS, ShoppingList.PROP_NAME });
		addShoppingList.addInputWithAddEffect(INPUT_SHOPPINGDATE_URI, TypeMapper
				.getDatatypeURI(String.class), 1, 1, new String[] {
				FoodManagement.PROP_SHOPPINGLIST_CONTROLS, ShoppingList.PROP_DATE });
		addShoppingList.addInputWithAddEffect(INPUT_FOOD_ITEMS, FoodItem.MY_URI, 0, 0, new String[] {
				FoodManagement.PROP_SHOPPINGLIST_CONTROLS, ShoppingList.PROP_HAS_FOODITEMS });
		...
		getShoppingItems.addOutput(OUTPUT_SHOPPING_ITEMS, FoodItem.MY_URI, 0, 0, new String[] 
				{FoodManagement.PROP_SHOPPINGLIST_CONTROLS,ShoppingList.PROP_HAS_FOODITEMS,FoodItem.PROP_NAME });
		...
		removeShoppingList.addInputWithRemoveEffect(INPUT_SHOPPINGNAME_URI, TypeMapper
				.getDatatypeURI(String.class), 1, 1, new String[] {	FoodManagement.PROP_SHOPPINGLIST_CONTROLS, ShoppingList.PROP_NAME });
