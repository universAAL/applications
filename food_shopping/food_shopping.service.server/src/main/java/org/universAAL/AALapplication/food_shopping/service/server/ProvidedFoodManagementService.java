...
public class ProvidedFoodManagementService extends FoodManagement {
	...
	addRestriction(MergedRestriction.getAllValuesRestrictionWithCardinality(Refrigerator.PROP_TEMPERATURE,
		...
		getShoppingItems.addOutput(OUTPUT_SHOPPING_ITEMS, FoodItem.MY_URI, 0, 0, new String[] {	FoodItem.MY_URI });
		...
		getShoppingLists.addOutput(OUTPUT_SHOPPING_LISTS, ShoppingList.MY_URI, 0, 0, new String[] {	ShoppingList.MY_URI });
		...
		getShoppingListItems.addFilteringInput(INPUT_SHOPPINGLIST_URI, ShoppingList.MY_URI, 1, 1, ppControls);
		getShoppingListItems.addInputWithAddEffect(INPUT_SHOPPINGNAME_URI, TypeMapper
				.getDatatypeURI(String.class), 1, 1, new String[] {
				FoodManagement.PROP_CONTROLS, ShoppingList.PROP_NAME });
		...
		removeShoppingList.addFilteringInput(INPUT_SHOPPINGLIST_URI, ShoppingList.MY_URI, 1, 1, ppControls);
		removeShoppingList.addInputWithChangeEffect(INPUT_SHOPPINGNAME_URI, TypeMapper
				.getDatatypeURI(String.class), 1, 1, new String[] {
				FoodManagement.PROP_CONTROLS, ShoppingList.PROP_NAME });
		removeShoppingList.addInputWithChangeEffect(INPUT_SHOPPINGLISTID_URI, TypeMapper
				.getDatatypeURI(Integer.class), 1, 1, new String[] {
				FoodManagement.PROP_CONTROLS, ShoppingList.PROP_ID });
