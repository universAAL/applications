 ...
 */
package org.universAAL.AALapplication.hwo.model;
...
public class Point {
	...
	public static final String MY_URI = "http://ontology.universAAL.org/Location.owl#Point";
	public static Double PROP_X;
	public static Double PROP_Y;
	public static Double PROP_Z;
	public static CoordinateSystem PROP_COORDINATE_SYSTEM;
	...
	// /**
	// * Constructor just for usage by de-serializers. Do not use this
	// constructor
	// * within applications as it may lead to incomplete instances that cause
	// * exceptions.
	// */
...
//	}
	...
	public double[] get3DCoordinates() {
		double z = 0;
		if (PROP_Z!=null && !PROP_Z.equals(Double.NaN))
			z = (PROP_Z).doubleValue();
		double[] get3DCoordinates = {
				(PROP_X).doubleValue(),
				(PROP_Y).doubleValue(), z };
	...
	public double getX() {
		return (PROP_X).doubleValue();
	}

	public double getY() {
		return (PROP_Y).doubleValue();
	}
...
//				return (float) getDistanceFromLatLong(p1.get2DCoordinates(),
//						p2.get2DCoordinates());
//			} else {
