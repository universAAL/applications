...
INSERT INTO `calendartype` VALUES (1,'TestCalendarSaied',1),(2,'TestCalendarBob',5);
...
INSERT INTO `event` VALUES (1,1,2,'asd','asd',123123123,12312312312123,NULL,2,1),(2,1,NULL,'asd<sd','asd<ys',31,213,NULL,NULL,1),(3,1,3,'asdf','asdf',12341234,12,NULL,NULL,1);
...
INSERT INTO `reminder` VALUES (1,1,1314867600000,5,5,'Take meds now!'),(2,2,234234,2,2,'bb'),(3,2,123123123,1,33,'ttt');
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=latin1 COMMENT='User data.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,1,'TestName','TestSurname','TestAddress',1,'saied','test'),(5,1,NULL,NULL,NULL,NULL,'bob',NULL);
...
-- Dump completed on 2013-02-05 20:16:40
