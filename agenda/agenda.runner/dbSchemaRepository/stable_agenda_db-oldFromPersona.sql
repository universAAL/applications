...
--
-- Definition of table `extendedevent`
--

DROP TABLE IF EXISTS `extendedevent`;
CREATE TABLE `extendedevent` (
  ...
  `eDescription` varchar(300) DEFAULT NULL,
  ...
  PRIMARY KEY (`eventID`),
  KEY `FK_extendedevent_1` (`parentID`),
  CONSTRAINT `FK_extendedevent_1` FOREIGN KEY (`parentID`) REFERENCES `calendar` (`calendarID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=236 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `extendedevent`
--

/*!40000 ALTER TABLE `extendedevent` DISABLE KEYS */;
INSERT INTO `extendedevent` (`eventID`,`eCategory`,`ePlace`,`eSpokenLang`,`eStartTime`,`eDbStartTime`,`eEndTime`,`eDbEndTime`,`eDescription`,`rMessage`,`rTime`,`rDbTime`,`rRepeatTimes`,`rReminderType`,`aCountryName1`,`aExtAddress`,`aLocality`,`aPostalCode`,`aRegion`,`aStreetName`,`aBuilding`,`isPersistent`,`parentID`,`rInterval`,`isVisible`) VALUES 
...
INSERT INTO `extendedevent` (`eventID`,`eCategory`,`ePlace`,`eSpokenLang`,`eStartTime`,`eDbStartTime`,`eEndTime`,`eDbEndTime`,`eDescription`,`rMessage`,`rTime`,`rDbTime`,`rRepeatTimes`,`rReminderType`,`aCountryName1`,`aExtAddress`,`aLocality`,`aPostalCode`,`aRegion`,`aStreetName`,`aBuilding`,`isPersistent`,`parentID`,`rInterval`,`isVisible`) VALUES 
 ...
 (233,'dinner','local goodys','ell','2009-09-09 14:30:00',1252495800705,NULL,NULL,'avsdv','dsgsdfsdf','2009-09-09 15:20:00',1252498800469,2,3,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,6,600000,1);
INSERT INTO `extendedevent` (`eventID`,`eCategory`,`ePlace`,`eSpokenLang`,`eStartTime`,`eDbStartTime`,`eEndTime`,`eDbEndTime`,`eDescription`,`rMessage`,`rTime`,`rDbTime`,`rRepeatTimes`,`rReminderType`,`aCountryName1`,`aExtAddress`,`aLocality`,`aPostalCode`,`aRegion`,`aStreetName`,`aBuilding`,`isPersistent`,`parentID`,`rInterval`,`isVisible`) VALUES 
 (234,'Test','everywhere','ell','2009-09-11 10:10:00',1252653000378,NULL,NULL,'Just to test the month',NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,6,0,1),
 (235,'Technical metting','HIT/CERTH','ell','2009-09-21 09:00:00',1253512800711,'2009-09-21 17:00:00',1253541600711,NULL,'hello there','2009-09-17 13:12:00',1253182320070,2,3,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,20,60000,1);
/*!40000 ALTER TABLE `extendedevent` ENABLE KEYS */;
