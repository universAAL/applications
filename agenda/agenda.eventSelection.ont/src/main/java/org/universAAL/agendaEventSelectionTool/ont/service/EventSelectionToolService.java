...
public class EventSelectionToolService extends Service {
    ...
    static {
	// URI =
	// http://ontology.persona.anco.gr/EventSelectionTool.owl#EventSelectionToolService
	...
	PROP_CONTROLS = EventSelectionTool.EVENT_SELECTION_TOOL_NAMESPACE
		+ "controls";
	...
	addRestriction(Restriction.getAllValuesRestriction(PROP_CONTROLS,
		EventSelectionTool.MY_URI), new String[] { PROP_CONTROLS },
