...
public class DateUtilities {
	...
	// TODO: now it's inactive, should be used with l10n
	public static String dayEnding(String dayNumber) {
		if (true)
			return ""; //$NON-NLS-1$

		if (dayNumber.endsWith("11")) //$NON-NLS-1$
			return "th"; //$NON-NLS-1$
		if (dayNumber.endsWith("12")) //$NON-NLS-1$
			return "th"; //$NON-NLS-1$
		if (dayNumber.endsWith("13")) //$NON-NLS-1$
			return "th"; //$NON-NLS-1$
