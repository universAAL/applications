...
public class JEventInfo implements PersonaWindow, EventInfoListener {
	...
	private JPanel mainScreen() {
		...
		// CALENDAR ELEMENTS
		List<org.universAAL.agenda.ont.Calendar> calList = parent
				.getActiveCalendars();
		// org.universAAL.agenda.ont.Calendar[] calArray = new
		// org.universAAL.agenda.ont.Calendar[calList.size()];
	...
	private void updateCalendarComboBox(
			List<org.universAAL.agenda.ont.Calendar> calendars) {
		...
		for (org.universAAL.agenda.ont.Calendar calendar : calendars) {
	...
	public void populateData(Event event, boolean editMode) {
		...
		org.universAAL.agenda.ont.Calendar parentCal = event
				.getParentCalendar();
		...
		System.out.println("Set Parent Calendar: "
				+ ((org.universAAL.agenda.ont.Calendar) calendarCombo
	...
	private void updateOrSaveEvent() {
		...
		org.universAAL.agenda.ont.Calendar calendar = null;
		System.out.println(">>> Combo current value: "
				+ calendarCombo.getSelectedIndex());
		if (currentStatus == SAVE_NEW_EVENT
				|| (oldCalendarComboValue != calendarCombo.getSelectedIndex())) {
			calendar = (org.universAAL.agenda.ont.Calendar) calendarCombo
					.getSelectedItem();
