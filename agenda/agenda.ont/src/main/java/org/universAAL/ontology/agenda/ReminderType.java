...
public class ReminderType extends ManagedIndividual {
    ...
    static {
	MY_URI = Calendar.CALENDAR_NAMESPACE
		+ Messages.getString("ReminderType.0"); //$NON-NLS-1$
