...
//		}
//		// --Input processing--
//		log.info ("doPost Input processing: req.getHeader(Authorization)-> " + req.getHeader("Authorization"));
//		
//		
...
//		String userURI = userURIs.get(userPass[0]);
		...
		String userURI = Constants.uAAL_MIDDLEWARE_LOCAL_ID_PREFIX+"tester";
