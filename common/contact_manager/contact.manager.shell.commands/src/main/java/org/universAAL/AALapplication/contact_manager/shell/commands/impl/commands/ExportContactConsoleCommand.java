 ...
 */
public final class ExportContactConsoleCommand extends ConsoleCommand {

  private static final String COMMAND = COMMAND_PREFIX + ':' + EXPORT_CONTACT + " command";

  public ExportContactConsoleCommand(String name, String description) {
