 ...
 */
public final class RemoveContactConsoleCommand extends ConsoleCommand {

  private static final String COMMAND = COMMAND_PREFIX + ':' + REMOVE_CONTACT + " command";

  public RemoveContactConsoleCommand(String name, String description) {
