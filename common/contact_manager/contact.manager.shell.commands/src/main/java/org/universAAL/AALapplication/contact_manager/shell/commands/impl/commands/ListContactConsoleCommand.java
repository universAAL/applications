 ...
 */
public final class ListContactConsoleCommand extends ConsoleCommand {

  private static final String COMMAND = COMMAND_PREFIX + ':' + LIST_CONTACTS + " command";

  public ListContactConsoleCommand(String name, String description) {
