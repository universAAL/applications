 ...
 */
public final class ImportContactConsoleCommand extends ConsoleCommand {

  private static final String COMMAND = COMMAND_PREFIX + ':' + IMPORT_CONTACT + " command";

  public ImportContactConsoleCommand(String name, String description) {
