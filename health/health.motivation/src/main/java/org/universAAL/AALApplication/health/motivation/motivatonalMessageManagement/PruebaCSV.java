...
public class PruebaCSV {
	...
	public static void leeFichero(){
		try{
			...
			if (reader.readHeaders()) {
				...
				System.out.println("Tama�o de Headers: " + headers.length);
			}
			while(reader.readRecord()){
				...
				System.out.println("N�mero de cols: " + cols.length);
	...
	public static void pruebaMManager(FileReader freader){
		...
		try {
			...
			/*System.out.println("tama�o del mapa" + map.size());
...
public static Object getMotivationalMessageContent(String disease, String treatmentType, MotivationalStatusType motStatus, MotivationalMessageClassification messageType) {
		...
		System.out.println("He entrado en el m�todo que lee el contenido");
		System.out.println("tama�o del mapa" + map.size());
		...
		System.out.println("Tama�o de los resultados: " + mMessageResults.size());
		if (mMessageResults.size() > 1) { // there are several messages for the
			// same combination of keys
			System.out.println("Hay m�s de un resultado");
...
//			
			System.out.println("S�lo hay un resultado");
