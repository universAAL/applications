...
public class UserHealthProfile extends HealthProfile {
	...
	static {
		MY_URI = TREATMENT_NAMESPACE + "UserHealthProfile";
		PROP_HAS_TREATMENT = TREATMENT_NAMESPACE + "hasTreatment";
				
		register(UserHealthProfile.class);
    }

	public static Restriction getClassRestrictionsOnProperty(String propURI) {
    	
    	if (PROP_HAS_TREATMENT.equals(propURI))
			return Restriction.getAllValuesRestrictionWithCardinality(propURI, Treatment.MY_URI, -1, 0);
	...
	public static String[] getStandardPropertyURIs() {
        ...
        String[] proper = {PROP_HAS_TREATMENT};
	...
	public static String getRDFSComment() {
		return "User's health profile has a treatment";
	}

	public static String getRDFSLabel() {
		return "User Health Treatment";
	}
	...
	public UserHealthProfile(String uri) {
		super(uri);
	}
