...
public class UnidimensionalMeasure extends Measure {
	...
	static {
		...
		register(UnidimensionalMeasure.class);
    }
	...
	public static String getRDFSComment() {
		return "The description of a unidimensional measure";
	}

	public static String getRDFSLabel() {
		return "Unidimensional measure";
	}
	...
	public UnidimensionalMeasure() {
		
	}

	public UnidimensionalMeasure(String uri) {
		super(uri);
	}

	public UnidimensionalMeasure(String uriPrefix, int numProps) {
