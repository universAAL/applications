...
public class Questionnaire4TreatmentStrategy extends Questionnaire{
	...
	//NAMESPACE & PROPERTIES
	  ...
	  public Questionnaire4TreatmentStrategy (Treatment t, String name, String description, Question[] questions) {
		    super(name, description, questions);
		    this.setAssociatedTreatment(t);
	  }
	  
	  public Questionnaire4TreatmentStrategy (Treatment t, String name, String description, Question question) {
		    super(name, description, question);
		    this.setAssociatedTreatment(t);
	  }
	  
	  public Questionnaire4TreatmentStrategy (Treatment t, String name, String description, Question[] questions, boolean ordered) {
		    super(name, description, questions, ordered);
		    this.setAssociatedTreatment(t);
	  }
	  
	  public Questionnaire4TreatmentStrategy (Treatment t, String name, String description) {
	...
	public String getClassURI() {
	  ...
	  public boolean isWellFormed() {
		return true 
	      && props.containsKey(PROP_IS_ASSOCIATED_TO_TREATMENT)
	      ;
	  }
