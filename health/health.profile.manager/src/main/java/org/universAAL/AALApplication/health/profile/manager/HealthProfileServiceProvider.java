 ...
 *
 */
public class HealthProfileServiceProvider extends ServiceCallee {
	 ...
	 */
	protected HealthProfileServiceProvider(ModuleContext context,
			ServiceProfile[] realizedServices) {
		super(context, realizedServices);
		psm = new ProfileServerHealthProfileProvider(context);
	}
	
	public HealthProfileServiceProvider(ModuleContext context) {
