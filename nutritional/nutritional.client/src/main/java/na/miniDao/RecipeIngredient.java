...
public class RecipeIngredient implements java.io.Serializable {
    ...
    public RecipeIngredient(int foodID, int recipeIngredientsID,
	    int measUnitsID, int foodCategoryID, int foodSubCategoryID,
	    java.lang.String picture, java.lang.String foodSubCategory,
	    java.lang.String foodCategory, java.lang.String description,
	    java.lang.String measureDescription, double quantity) {
	this.foodID = foodID;
	...
	_equals = true
		...
		&& ((this.foodSubCategory == null && other.getFoodSubCategory() == null) || (this.foodSubCategory != null && this.foodSubCategory
			.equals(other.getFoodSubCategory())))
		&& ((this.foodCategory == null && other.getFoodCategory() == null) || (this.foodCategory != null && this.foodCategory
			.equals(other.getFoodCategory())))
		&& ((this.description == null && other.getDescription() == null) || (this.description != null && this.description
			.equals(other.getDescription())))
		&& ((this.measureDescription == null && other
			.getMeasureDescription() == null) || (this.measureDescription != null && this.measureDescription
			.equals(other.getMeasureDescription())))
