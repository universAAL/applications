...
public class AdviseTime implements java.io.Serializable {
    ...
    public AdviseTime(int mealType, boolean usePatientTime,
	...
	_hashCode += (isUsePatientTime() ? Boolean.TRUE : Boolean.FALSE)
		.hashCode();
	if (getTime() != null) {
