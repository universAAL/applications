...
public class Advise implements java.io.Serializable {
    ...
    public Advise(int ID, java.lang.String title, java.lang.String message,
	    java.lang.String picture, int status,
	    na.miniDao.NutriCalendar startDate,
	    na.miniDao.NutriCalendar endDate, int frequency, int startWeek,
	    int[] activeOnDays, na.miniDao.AdviseTimeInfo timeInfo,
	...
	_equals = true
		...
		&& ((this.activeOnDays == null && other.getActiveOnDays() == null) || (this.activeOnDays != null && java.util.Arrays
			.equals(this.activeOnDays, other.getActiveOnDays())))
		&& ((this.timeInfo == null && other.getTimeInfo() == null) || (this.timeInfo != null && this.timeInfo
			.equals(other.getTimeInfo())))
		&& ((this.otherConditions == null && other.getOtherConditions() == null) || (this.otherConditions != null && this.otherConditions
			.equals(other.getOtherConditions())));
	__equalsCalc = null;
	return _equals;
    }
