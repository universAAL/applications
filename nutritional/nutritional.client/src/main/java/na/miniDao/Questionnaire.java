...
public class Questionnaire implements java.io.Serializable {
    ...
    public Questionnaire(int ID, int userID, java.lang.String type,
	    java.lang.String state, java.lang.String description,
	    java.lang.String title, na.miniDao.NutriDate creationDate,
	    na.miniDao.Exercise[] exercises, na.miniDao.Question[] questions) {
	this.ID = ID;
	this.userID = userID;
	this.type = type;
	this.state = state;
	...
	_equals = true
		...
		&& ((this.creationDate == null && other.getCreationDate() == null) || (this.creationDate != null && this.creationDate
			.equals(other.getCreationDate())))
		&& ((this.exercises == null && other.getExercises() == null) || (this.exercises != null && java.util.Arrays
			.equals(this.exercises, other.getExercises())))
		&& ((this.questions == null && other.getQuestions() == null) || (this.questions != null && java.util.Arrays
			.equals(this.questions, other.getQuestions())));
	__equalsCalc = null;
	return _equals;
    }
