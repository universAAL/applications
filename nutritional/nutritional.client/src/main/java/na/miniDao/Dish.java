...
public class Dish implements java.io.Serializable {
    ...
    public Dish(int usersMenuDishesID, java.lang.String description,
	    int recipeID, java.lang.String image, byte[] imageBytes,
	    int dishCategory, boolean hasProcedure, boolean containsRecipe) {
	...
	_equals = true
		...
		&& ((this.image == null && other.getImage() == null) || (this.image != null && this.image
	...
	_hashCode += (isHasProcedure() ? Boolean.TRUE : Boolean.FALSE)
		.hashCode();
	_hashCode += (isContainsRecipe() ? Boolean.TRUE : Boolean.FALSE)
		.hashCode();
