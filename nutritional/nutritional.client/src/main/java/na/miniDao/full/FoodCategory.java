...
public class FoodCategory implements java.io.Serializable {
    ...
    public FoodCategory(int ID, java.lang.String name,
	...
	_equals = true
		...
		&& ((this.subCategories == null && other.getSubCategories() == null) || (this.subCategories != null && java.util.Arrays
			.equals(this.subCategories, other.getSubCategories())));
	__equalsCalc = null;
	return _equals;
    }
	...
	elemField.setXmlName(new javax.xml.namespace.QName(
		"http://full.miniDao/", "subCategories"));
	elemField.setXmlType(new javax.xml.namespace.QName(
