...
public class Recipe implements java.io.Serializable {
    ...
    public Recipe(int recipeID, java.lang.String course,
	    java.lang.String dishCategory, java.lang.String procedure,
	    java.lang.String picture, boolean favouriteRecipe,
	...
	_equals = true
		...
		&& ((this.course == null && other.getCourse() == null) || (this.course != null && this.course
			.equals(other.getCourse())))
		&& ((this.dishCategory == null && other.getDishCategory() == null) || (this.dishCategory != null && this.dishCategory
			.equals(other.getDishCategory())))
		&& ((this.procedure == null && other.getProcedure() == null) || (this.procedure != null && this.procedure
		...
		&& ((this.recipeIngredients == null && other
			.getRecipeIngredients() == null) || (this.recipeIngredients != null && java.util.Arrays
			.equals(this.recipeIngredients,
				other.getRecipeIngredients())))
	...
	_hashCode += (isFavouriteRecipe() ? Boolean.TRUE : Boolean.FALSE)
		.hashCode();
	if (getRecipeIngredients() != null) {
	    for (int i = 0; i < java.lang.reflect.Array
		    .getLength(getRecipeIngredients()); i++) {
		java.lang.Object obj = java.lang.reflect.Array.get(
			getRecipeIngredients(), i);
