...
public class ShoppingList implements java.io.Serializable {
    ...
    public ShoppingList(int userID, na.miniDao.FoodItem[] items) {
	this.userID = userID;
	this.items = items;
    }
	...
	_equals = true
		...
		&& ((this.items == null && other.getItems() == null) || (this.items != null && java.util.Arrays
			.equals(this.items, other.getItems())));
	__equalsCalc = null;
	return _equals;
    }
	...
	if (getItems() != null) {
		...
		java.lang.Object obj = java.lang.reflect.Array.get(getItems(),
			i);
