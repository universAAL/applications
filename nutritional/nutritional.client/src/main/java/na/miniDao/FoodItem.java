...
public class FoodItem implements java.io.Serializable {
    ...
    public FoodItem(int foodID, int shoppingListID, java.lang.String name,
	    java.lang.String category, java.lang.String amount,
	    java.lang.String units, java.lang.String source,
	    int foodSubCategoryID, int foodCategoryID) {
	this.foodID = foodID;
