...
public class Meal implements java.io.Serializable {
    ...
    public Meal(int usersMenuMealsID, java.lang.String category,
	...
	_equals = true
		...
		&& ((this.dishes == null && other.getDishes() == null) || (this.dishes != null && java.util.Arrays
			.equals(this.dishes, other.getDishes())));
	__equalsCalc = null;
	return _equals;
    }
	...
	if (getDishes() != null) {
	    for (int i = 0; i < java.lang.reflect.Array.getLength(getDishes()); i++) {
		java.lang.Object obj = java.lang.reflect.Array.get(getDishes(),
			i);
