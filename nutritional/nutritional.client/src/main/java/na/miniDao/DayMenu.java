...
public class DayMenu implements java.io.Serializable {
    ...
    public DayMenu(int actualDay, int usersMenusID, na.miniDao.Meal[] meals,
	    int breakfastIndex, int lunchIndex, int dinnerIndex,
	    int midmorningSnackIndex, int afternoonSnackIndex,
	...
	_equals = true
		...
		&& ((this.meals == null && other.getMeals() == null) || (this.meals != null && java.util.Arrays
			.equals(this.meals, other.getMeals())))
		...
		&& this.afterdinnerSnackIndex == other
			.getAfterdinnerSnackIndex();
	__equalsCalc = null;
	return _equals;
    }
	...
	if (getMeals() != null) {
	    for (int i = 0; i < java.lang.reflect.Array.getLength(getMeals()); i++) {
		java.lang.Object obj = java.lang.reflect.Array.get(getMeals(),
			i);
