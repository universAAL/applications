...
public class NutritionalAdvisorProxy implements na.ws.NutritionalAdvisor {
	...
	try {
	    nutritionalAdvisor = (new na.ws.NutritionalAdvisorServiceLocator())
		    .getNutritionalAdvisorPort();
	    if (nutritionalAdvisor != null) {
		if (_endpoint != null)
		    ((javax.xml.rpc.Stub) nutritionalAdvisor)
			    ._setProperty(
				    "javax.xml.rpc.service.endpoint.address",
				    _endpoint);
		else
		    _endpoint = (String) ((javax.xml.rpc.Stub) nutritionalAdvisor)
	...
	_endpoint = endpoint;
	if (nutritionalAdvisor != null)
	    ((javax.xml.rpc.Stub) nutritionalAdvisor)._setProperty(
	...
	if (nutritionalAdvisor == null)
	    _initNutritionalAdvisorProxy();
	return nutritionalAdvisor.getCustomShoppingListDays(token, windowSize,
		startDay);
    }
	...
	if (nutritionalAdvisor == null)
	    _initNutritionalAdvisorProxy();
	return nutritionalAdvisor.getNextQuestion(token, exerciseID,
		userQuestionnaireID, questionID);
    }
	...
	if (nutritionalAdvisor == null)
	    _initNutritionalAdvisorProxy();
	return nutritionalAdvisor.getPreviousQuestion(token, exerciseID,
		userQuestionnaireID, questionID);
    }
	...
	if (nutritionalAdvisor == null)
	    _initNutritionalAdvisorProxy();
	return nutritionalAdvisor.getSmartCustomShoppingListDays(token,
		windowSize, startDay, outsideEvents);
    }
	...
	if (nutritionalAdvisor == null)
	    _initNutritionalAdvisorProxy();
	return nutritionalAdvisor.getStartingQuestionnaire(token,
		questionnaireID, exerciseID);
    }
	...
	if (nutritionalAdvisor == null)
	    _initNutritionalAdvisorProxy();
	return nutritionalAdvisor.getToken(username, password,
		preferredLanguage);
    }
	...
	if (nutritionalAdvisor == null)
	    _initNutritionalAdvisorProxy();
	return nutritionalAdvisor.setQuestionnaireAnswer(token, exerciseID,
    ...
    // if (nutritionalAdvisor == null)
    // _initNutritionalAdvisorProxy();
    // return nutritionalAdvisor.setSingleProfileProperty(token, username,
    // propertyName, value);
    // }
    //
    ...
    // if (nutritionalAdvisor == null)
    // _initNutritionalAdvisorProxy();
    // return nutritionalAdvisor.setProfileProperty(token, username,
    // propertyName,
    // value);
    // }
    ...
    // int patientID, String[] values, boolean isMultiple) throws
    // NutriSecurityException, TokenExpiredException, RemoteException {
    // if (nutritionalAdvisor == null)
    // _initNutritionalAdvisorProxy();
    // return nutritionalAdvisor.setSingleProfileProperty( token, type,
    // propertyParentName, propertyChildrenName,
    ...
    // if (nutritionalAdvisor == null)
    // _initNutritionalAdvisorProxy();
    // return nutritionalAdvisor.setProfileProperty( token, patientID,
    // propertyName, value);
    // }
