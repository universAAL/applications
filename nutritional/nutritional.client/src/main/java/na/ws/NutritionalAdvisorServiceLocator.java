...
public class NutritionalAdvisorServiceLocator extends
	org.apache.axis.client.Service implements
	na.ws.NutritionalAdvisorService {
    ...
    public NutritionalAdvisorServiceLocator(java.lang.String wsdlLoc,
    ...
    private java.lang.String NutritionalAdvisorPort_address = Setup
	    .getWebServiceAddress();

    // private java.lang.String NutritionalAdvisorPort_address =
    // "http://localhost:8080/NutriAdvisor_uAAL/NutritionalAdvisor";
    ...
    public na.ws.NutritionalAdvisor getNutritionalAdvisorPort()
	    throws javax.xml.rpc.ServiceException {
	...
	try {
	    na.ws.NutritionalAdvisorBindingStub _stub = new na.ws.NutritionalAdvisorBindingStub(
		    portAddress, this);
    ...
    public void setNutritionalAdvisorPortEndpointAddress(
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface)
	    throws javax.xml.rpc.ServiceException {
	try {
	    if (na.ws.NutritionalAdvisor.class
		    .isAssignableFrom(serviceEndpointInterface)) {
		na.ws.NutritionalAdvisorBindingStub _stub = new na.ws.NutritionalAdvisorBindingStub(
			new java.net.URL(NutritionalAdvisorPort_address), this);
		_stub.setPortName(getNutritionalAdvisorPortWSDDServiceName());
		return _stub;
	    }
