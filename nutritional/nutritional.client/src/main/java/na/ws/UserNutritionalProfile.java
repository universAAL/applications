...
public class UserNutritionalProfile implements java.io.Serializable {
    ...
    public UserNutritionalProfile(java.lang.String statusResponse, int version,
	    double timeinmillis, int userID, na.ws.UProperty[] properties) {
	...
	if (!(obj instanceof UserNutritionalProfile))
	    return false;
	...
	boolean _equals;
	_equals = true
		&& ((this.statusResponse == null && other.getStatusResponse() == null) || (this.statusResponse != null && this.statusResponse
    ...
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
	    UserNutritionalProfile.class, true);
	...
	elemField
		.setXmlName(new javax.xml.namespace.QName("", "statusResponse"));
	...
	elemField.setXmlType(new javax.xml.namespace.QName("http://ws.na/",
		"uProperty"));
	elemField.setMinOccurs(0);
	elemField.setNillable(false);
