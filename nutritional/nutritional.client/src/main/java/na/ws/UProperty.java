...
public class UProperty implements java.io.Serializable {
    ...
    public UProperty(java.lang.String code,
	    na.ws.UPropertyValues default_Value, na.ws.UPropertyValues[] values) {
	this.code = code;
	...
	_equals = true
		...
		&& ((this.default_Value == null && other.getDefault_Value() == null) || (this.default_Value != null && this.default_Value
			.equals(other.getDefault_Value())))
	...
	elemField
		.setXmlName(new javax.xml.namespace.QName("", "default_Value"));
