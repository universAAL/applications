...
public class UpdateEventInput  implements java.io.Serializable {
    ...
    private na.oasisUtils.socialCommunity.Agenda.Event event;
    ...
    public UpdateEventInput(
           ...
           na.oasisUtils.socialCommunity.Agenda.Event event) {
    ...
    /**
     * Gets the auth_token value for this UpdateEventInput.
     * 
     * @return auth_token
     */
    ...
    /**
     * Sets the auth_token value for this UpdateEventInput.
     * 
     * @param auth_token
     */
    ...
    /**
     * Gets the event value for this UpdateEventInput.
     * 
     * @return event
     */
    public na.oasisUtils.socialCommunity.Agenda.Event getEvent() {
        return event;
    }


    /**
     * Sets the event value for this UpdateEventInput.
     * 
     * @param event
     */
    public void setEvent(na.oasisUtils.socialCommunity.Agenda.Event event) {
        this.event = event;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof UpdateEventInput)) return false;
        UpdateEventInput other = (UpdateEventInput) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(UpdateEventInput.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:Agenda", "UpdateEventInput"));
