...
//		return val;
	...
	public boolean getHasLocalCholesterol() {
		...
		UProperty myProperty = this.getUProperty(property);
		if (myProperty!=null && myProperty.getValues()!=null && myProperty.getValues(0).getValue().length()>0)
			return true;
		else
			return false;
	}
...
//		
//		// CARER EMAIL
//		setUserValue(fe, Nutrition.CARER_EMAIL, AMIPrefTypes.AMI_STRING, "hecgamar@itaca.upv.es");
//		
//		// DIET TYPE
//		setUserValue(fe, Habits.DIET_TYPE, AMIPrefTypes.AMI_STRING, "mediterranean");
//		
//		// BREAKFAST HOUR
//		setUserValue(fe, Habits.BREAKFAST_HOUR, AMIPrefTypes.AMI_STRING, "08:30");
//		
//		// LUNCH HOUR
...
////		setUserValue(fe, NutriPreferences.FAVOURITE_RECIPES, AMIPrefTypes.AMI_STRING_LIST, list);
//		
////		// CHRONIC DISEASES, deprecated
////		list = new ArrayList<String>();
////		list.add("diabetes");
////		setUserValue(fe, Health.CHRONIC_DISEASES, AMIPrefTypes.AMI_STRING_LIST, list);
//		
//		// ALLERGIES
//		list = new ArrayList<String>();
//		list.add("0@1@Milk products");
//		setUserValue(fe, Health.FOOD_ALLERGIES, AMIPrefTypes.AMI_STRING_LIST, list);
//		
//		// DISLIKES
//		list = new ArrayList<String>();
//		list.add("49@Globe Artichoke");
//		setUserValue(fe, NutriPreferences.FOOD_DISLIKES, AMIPrefTypes.AMI_STRING_LIST, list);
//		
//		// CHRONIC DISEASES
//		list = new ArrayList<String>();
//		list.add("milky products");
//		setUserValue(fe, Health.FOOD_INTOLERANCES, AMIPrefTypes.AMI_STRING_LIST, list);
//		
//		// PREFERRED FOODS
//		list = new ArrayList<String>();
//		list.add("5@Rice raw");
...
//		setUserValue(fe, NutriPreferences.PREFERRRED_FOODS, AMIPrefTypes.AMI_STRING_LIST, list);
//		
//		// Weekly Phisycal Activity Level
//		setUserValue(fe, NP.Nutrition.PhysicalActivity.LEVEL_WEEKLY_ACTIVITY, AMIPrefTypes.AMI_STRING, "moderate");
//		
//		// abdominal_skinfold
//		setUserValue(fe, NP.Nutrition.Anthropometrics.ABDOMINAL_SKINFOLD, AMIPrefTypes.AMI_DOUBLE, "26.54");
//		
//		// subscapular sk
//		setUserValue(fe, NP.Nutrition.Anthropometrics.SUBSCAPULAR_SKINFOLD, AMIPrefTypes.AMI_DOUBLE, "20.94");
//		
//		// suprailiac skin
//		setUserValue(fe, NP.Nutrition.Anthropometrics.SUPRAILIAC_SKINFOLD, AMIPrefTypes.AMI_DOUBLE, "17.29");
//
//		// triceps skin
//		setUserValue(fe, NP.Nutrition.Anthropometrics.TRICEPS_SKINFOLD, AMIPrefTypes.AMI_DOUBLE, "16.12");
//
//		log.info("Flushing... ");
//		this.frontEnd.flush();
//		log.info("DONE");
...
//		String userName = Setup.getAMI_UserName();
//		System.out.println("Setting extra nutrition data for patient: "+ userName);
//
//		ProfileDesktopFrontend fe = this.frontEnd;
//		
//		setUserValue(fe, Nutrition.USERNAME, AMIPrefTypes.AMI_STRING, "David_Shopland");
//		setUserValue(fe, Nutrition.PASSWORD, AMIPrefTypes.AMI_STRING, "5a019bc5dad45f1652c141bc9004598b");
////		User user = new User();
////		user.setUserName(USERNAME);
////		fe.init(user, "oasis");
////		fe.downloadProfileFromServer();
...
//		
////		// CARER EMAIL
////		setUserValue(fe, Nutrition.Habits.NUTRITIONAL_GOAL, AMIPrefTypes.AMI_STRING, "losing weight");
////		
//////		// DIET TYPE
//////		setUserValue(fe, Habits.DIET_TYPE, AMIPrefTypes.AMI_STRING, "mediterranean");
////		
////		// rec daily meals
////		setUserValue(fe, Habits.RECOMMENDED_DAILY_MEALS, AMIPrefTypes.AMI_STRING, "3");
////		
////		// rec food intake kcal
////		setUserValue(fe, Habits.RECOMMENDED_FOOD_INTAKE_CALORIES, AMIPrefTypes.AMI_STRING, "1000");
//
...
//	}
	...
	public boolean downloadProfileFromServer() {
		/*
		 *  Si existe, enviar version actual del profile del usuario logeado
		 *  	si error, null o caducado, descargar y guardar.
		 *  	si no, nada
		...
		try {
			UserNutritionalProfile profile = na.getUserProfile(TSFConnector.getInstance().getToken(), -1);
			if (profile.getStatusResponse().compareTo(NP.StatusResponse.STATUS_EXPIRED)==0 ||
				profile.getStatusResponse().compareTo(NP.StatusResponse.STATUS_INVALID)==0) 
	...
	private static void setProfile(UserNutritionalProfile profile) {
		...
		// recorrer todas las propiedades y crear una tabla con sus códigos para fácil acceso
		if (nutritionalProfile!=null && nutritionalProfile.getProperties()!=null && nutritionalProfile.getProperties().length>0) {
...
//		fe.downloadProfileFromServer();
//		fe.reload();
//		setUserValue(fe, "/common/user_email", AMIPrefTypes.AMI_STRING, "hecgamar@gmail.com");
...
//		setUserValue(fe, "/common/user_id", AMIPrefTypes.AMI_STRING, "itaca_user");
//		setUserValue(fe, "/common/name", AMIPrefTypes.AMI_STRING, "Peter");
//		setUserValue(fe, "/common/age_category", AMIPrefTypes.AMI_STRING, "Elderly");
//		setUserValue(fe, "/common/age", AMIPrefTypes.AMI_INTEGER, "50");
//		setUserValue(fe, "/common/preferred_language", AMIPrefTypes.AMI_STRING, "GB");
...
//		sl.add("GB");
//		setUserValue(fe, "/common/spoken_language", AMIPrefTypes.AMI_STRING_LIST, sl);		
//		fe.flush();
...
//	private static void setUserValue(ProfileDesktopFrontend fe, String propName, AMIPrefTypes type, List<String> values) {
...
//	}
//	
//	private static void setUserValue(ProfileDesktopFrontend fe, String propName, AMIPrefTypes type, String value) {
//		GenericProfileProperty pp = new GenericProfileProperty();
//		pp.setType(type);
//		pp.setAbsoluteName(propName);
//		pp.setValue(value);
...
//		}
//		
//		setUserValue(fe, NP.Nutrition.NutriPreferences.FAVOURITE_RECIPES, AMIPrefTypes.AMI_STRING_LIST, recipeList);
//		fe.flush();
//		boolean res = fe.upoladProfileToServer();	
//		log.info("Profile: uploaded! " + res);
//		return res;
...
//		// store value
//		String userName = Setup.getAMI_UserName();
//		log.info("Profile: UnSharing a recipe: " + recipeID + " on NutritionProfile: "+userName);
//		ProfileDesktopFrontend fe = this.frontEnd;
//		List<String> recipeList = this.getFavourite_Recipes();
...
//		}
//		
//		setUserValue(fe, NP.Nutrition.NutriPreferences.FAVOURITE_RECIPES, AMIPrefTypes.AMI_STRING_LIST, newRecipeList);
//		fe.flush();
//		boolean res = fe.upoladProfileToServer();	
...
//		if (ProfileConnector.getInstance().downloadProfileFromServer()== true) {
...
//		if (myProperty!=null && myProperty.getFirstValue()!=null && myProperty.getFirstValue().length()>0)
