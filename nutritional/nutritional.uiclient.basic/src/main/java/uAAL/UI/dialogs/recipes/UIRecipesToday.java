 ...
 * 
 */
public class UIRecipesToday extends CustomUICaller {

	private static Log log = LogFactory.getLog(UIRecipesToday.class);
	private final static String window = "UIRecipesToday#";
	...
	public UIRecipesToday(ModuleContext context) {
		super(context);
...
//				this.backToMainMenusDialog();
	...
	private DayMenu getMenu() {
		...
		try {
			...
			tomorrowMenuDescription = business.getTodayMenu();
