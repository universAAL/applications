...
//	    false, new String[] { USER_INPUT_REF1 });
	...
	Form f = Form.newDialog(Messages.getString("UIMenus.0") //$NON-NLS-1$
	...
	if (dayMenu != null) {
		...
		if (meal == null) {
			...
			Group groupDish = new Group(groupMeal, new Label(""
				/*Messages.getString("UIMenus.3")*/, null), PROP_PATH_REF1, null, //$NON-NLS-1$
				null);
			...
			if (dish == null) {
				...
				new MediaObject(groupDish, new Label(Messages.getString("UIMenus.4"), //$NON-NLS-1$
				...
				new Submit(groupDish, new Label(Messages.getString("UIMenus.6"), //$NON-NLS-1$
					null), SUBMIT_SEE_DETAILS
					+ dish.getRecipeID());
				System.out
					.println("recipe ID ............................................." //$NON-NLS-1$
						+ dish.getRecipeID());
			    }
			}
	...
	if(today){
	    new Submit(f.getSubmits(), new Label(Messages.getString("UIMenus.9"), null), SUBMIT_TOMORROW); //$NON-NLS-1$
	}else{
