 ...
 * 
 */
public class UIMenusTomorrow extends CustomUICaller {

	private static Log log = LogFactory.getLog(UIMenusTomorrow.class);
	private final static String window = "UIMenusTomorrow#";
	...
	public UIMenusTomorrow(ModuleContext context) {
		super(context);
...
//				this.backToMainMenusDialog();
	...
	public void showTodayMainDialog(CustomUICaller parentForm) {
		Utils.println(window + " showTodayMainDialog");
