 ...
 * 
 */
public class UIMenus extends CustomUICaller {

	private static Log log = LogFactory.getLog(UIMenus.class);
	private final static String window = "UIMenus#";
	...
	private Form initMainDialog() {
		...
		Form f = Form.newDialog("Nutritional Menus, Today", new Resource());
...
//		new SimpleOutput(f.getSubmits(), new Label("Today", null), null, "Today");
...
//				this.backToMainMenusDialog();
	...
	public void showTomorrwoMainDialog(CustomUICaller parentForm) {
		Utils.println(window + " showTomorrowMainDialog");
		UIMenusTomorrow menus = new UIMenusTomorrow(this.myContext);
