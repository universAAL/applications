...
// * 
// */
//class NutritionalConsumer extends ContextSubscriber {
//
...
//    }
//
//    NutritionalConsumer(ModuleContext mc) {
...
//		new String[] { Lighting.PROP_CONTROLS });
//
//	turnOn.addChangeEffect((new PropertyPath(null, true, new String[] {
//		Lighting.PROP_CONTROLS, LightSource.PROP_SOURCE_BRIGHTNESS }))
//		.getThePath(), new Integer(100));
//	return turnOn;
//    }
//
//    // see turnOffRequest
...
//		new String[] { Lighting.PROP_CONTROLS });
//
//	dim.addChangeEffect((new PropertyPath(null, true, new String[] {
//		Lighting.PROP_CONTROLS, LightSource.PROP_SOURCE_BRIGHTNESS }))
//		.getThePath(), percent);
//
//	return dim;
...
//		OUTPUT_LAMP_LOCATION), new String[] { Lighting.PROP_CONTROLS,
//		LightSource.PROP_PHYSICAL_LOCATION });
...
//		    NutritionalConsumer.class, "getReturnValue",
...
//					NutritionalConsumer.class,
//					"getReturnValue",
//					new Object[] { "Redundant return value ignored!" },
//					null);
//		else
//		    LogUtils.logInfo(SharedResources.moduleContext,
//			    NutritionalConsumer.class, "getReturnValue",
//			    new Object[] { "Irrelevant return value ignored: ",
//				    output.getURI() }, null);
//	    }
//
//	return returnValue;
...
//		OUTPUT_LIST_OF_LAMPS), new String[] { Lighting.PROP_CONTROLS });
//
//	return getAllLamps;
//    }
//
...
//		    // array of them
//		    allLightSources = (LightSource[]) ((List) value)
//			    .toArray(new LightSource[((List) value).size()]);
//
...
//			    sr = caller
//				    .call(getGetLampsLocationRequest(allLightSources[j]
//					    .getURI()));
//			    if (sr.getCallStatus() == CallStatus.succeeded) {
//				try {
//				    allLightSources[j]
//					    .setLocation((Location) getReturnValue(
//						    sr.getOutputs(),
//						    OUTPUT_LAMP_LOCATION));
//				} catch (Exception e) {
//				    LogUtils
//					    .logError(
//						    SharedResources.moduleContext,
//						    NutritionalConsumer.class,
//						    "getControlledLamps",
//						    new Object[] { "Exception caught while trying to interpret a return value as a location!" },
//						    e);
//				}
//			    } else
//				LogUtils.logInfo(SharedResources.moduleContext,
//					NutritionalConsumer.class,
//					"getControlledLamps", new Object[] {
//						"Status of getLocation(): ",
//						sr.getCallStatus() }, null);
//			}
//		    }
//
//		} catch (Exception e) {
...
//				    NutritionalConsumer.class,
//				    "getControlledLamps",
//				    new Object[] { "Exception caught while trying to interpret a return value as a list of light sources!" },
//				    e);
//		}
//	    } else {
//		LogUtils.logError(SharedResources.moduleContext,
//			NutritionalConsumer.class, "getControlledLamps",
//			new Object[] { "Status of getAllLamps(): ",
//				sr.getCallStatus() }, null);
//	    }
//	}
...
//	    System.out
//		    .println("LightingConsumer: wrong lampURI in turnOff(String lampURI)");
//	    return false;
//	}
//
...
//	else {
//	    System.out
//		    .println("LightingConsumer: the lamp couldn't turned off in turnOff(String lampURI)");
//	    return false;
//	}
//    }
//
...
//	if ((lampURI == null) || !(lampURI instanceof String)) {
//	    System.out
//		    .println("LightingConsumer: wrong lampURI in turnOn(String lampURI)");
//	    return false;
//	}
//
...
//	if (sr.getCallStatus() == CallStatus.succeeded) {
//	    System.out
//		    .println("LightingConsumer: SUCCESS: the lamp was turned on: "
//			    + lampURI);
//	    return true;
//	} else {
//	    System.out
//		    .println("LightingConsumer: the lamp couldn't turned on in turnOn(String lampURI)");
//	    return false;
//	}
//    }
//
...
//	    System.out
//		    .println("LightingConsumer: wrong inputs in dimToValue(String lampURI, Integer percent)");
//	    return false;
//	}
//
...
//	else {
//	    System.out
//		    .println("LightingConsumer: the lamp couldn't dimmed to wanted value in dimToValue(String lampURI, integer percent)");
//	    return false;
//	}
//    }
//
