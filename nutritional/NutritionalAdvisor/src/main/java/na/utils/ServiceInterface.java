...
public interface ServiceInterface {
	...
	/*
	 * Name of each service that the application loads
	 * The service must use the correspondent constant to register the service
	 * This constant is fully-qualified name of the Service main class, found by (class.getName())
	 */
	public static final String SERVICE_NUTRITIONAL_ADVISOR =  na.services.ServiceLauncher.class.getName();
	...
	public static final String DIR_NUTRITIONAL = Setup.DEFAULT_PATH_Nutritional_DESCRIPTOR+"/"+ Setup.getAMI_UserName()+"/";
//	public static final String DIR_NUTRITIONAL_USER = DIR_NUTRITIONAL + Setup.getAMI_UserName()+"/";
	public static final String USER_PROFILE_FILENAME = "UserProfile.xml";
//	public static final String USER_NUTRITIONAL_PROFILE_FILENAME = "UserNutritionalProfile.xml";
	...
	public static final String PATH_FOOD_INVENTORY = DIR_USER_PROFILE + DIR_NUTRITIONAL + FOOD_INVENTORY_FILENAME;
	public static final String SHARED_RECIPES_FILENAME = "shared_recipes.properties";
	public static final String PATH_SHARED_RECIPES = DIR_USER_PROFILE + DIR_NUTRITIONAL + SHARED_RECIPES_FILENAME;
	public static final String PATH_ADVISE_REPOSITORY = DIR_USER_PROFILE + DIR_NUTRITIONAL + ADVISE_REPOSITORY_FILENAME;
	public static final String PATH_SHOPPING_DATA = DIR_USER_PROFILE + DIR_NUTRITIONAL + SHOPPING_DATA_FILENAME;
	public static final String PATH_EXTRA_SHOPPING_ITEMS = DIR_USER_PROFILE + DIR_NUTRITIONAL + EXTRA_SHOPPING_ITEMS_FILENAME;
	public static final String FILENAME_USER_PROP = "user.properties";
	public static final String PATH_USER_FILE = DIR_USER_PROFILE + DIR_NUTRITIONAL + FILENAME_USER_PROP;
	public static final String PATH_TIPS_IMAGES = DIR_USER_PROFILE + DIR_NUTRITIONAL + "tips";
	public static final String PATH_TIPS = DIR_USER_PROFILE + DIR_NUTRITIONAL;
	public static final String PATH_MULTITEL_XMLS = DIR_USER_PROFILE + DIR_NUTRITIONAL + "Multitel/";
	...
	public static final String PATH_DISH_PICTURES = DIR_USER_PROFILE + DIR_NUTRITIONAL + DIR_IMAGES + "/"+DISH+"/";
	public static final String PATH_TIP_PICTURES = DIR_USER_PROFILE + DIR_NUTRITIONAL + DIR_IMAGES + "/"+TIP+"/";
	
	public static final String PATH_PDF_FILE = DIR_USER_PROFILE + DIR_NUTRITIONAL + "ShoppingList.pdf";
	...
	// listado de operaciones, IDEAL operations del AMI (nombres genéricos que ofrecen un servicio)
...
//	public static boolean stopThreads = false;
	...
	/**
	 * Sets the Service GUI on top of the parent widget
	 * Take into account the limited size
	 * @param parent
	 */
