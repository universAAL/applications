 ...
 */
public class NewMedicationTreatmentNotifier extends Service {

  public static final String MY_URI = MedicationOntology.NAMESPACE + "NewMedicationTreatmentNotifier";
  ...
  public NewMedicationTreatmentNotifier() {
    super();
  }

  public NewMedicationTreatmentNotifier(String uri) {
    super(uri);
  }
